...
namespace App1.Pages
{
    public static class Constants
    {
        ...
        public static string getUserDetailsURL = "https://safe-atoll-64469.herokuapp.com/bonds/api/user/";//requires username at the end
        public static string getProductsURL = "http://safe-atoll-64469.herokuapp.com/bonds/api/productinfo/";
        ...
        public static string createUserURL = "http://safe-atoll-64469.herokuapp.com/bonds/api/users/";//sent with user json
